				...
				<view class="page-scroll-child">
					...
					<view class="page-num" v-else>
						...
						<template v-else>
							...
							<!-- 左侧省略号 -->
							<view class="pag-btn ellipsis-btn" :style="{color}" v-show="(forceEllipses && getFirstPage > 2) || (numAround && getFirstPage != 2)"><text class="icon icon-more"></text></view>
							...
							<!-- 右侧省略号 -->
							<view class="pag-btn ellipsis-btn" :style="{color}" v-show="(forceEllipses && getFirstPage<pageNum-(showPageSize-2)) || (numAround && getFirstPage < pageNum-(showPageSize-2))">
